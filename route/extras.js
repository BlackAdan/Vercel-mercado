...
const Modelo = require('../models/SanMartin/Extras')

const router = Router()

//obtener un dato
router.get('/api/extras/:id', async (req, res) => {
    let {id} = req.params    
...
router.delete('/api/extras/',async (req, res) => {
    try{        
...
router.put('/api/extras/:id',async (req, res) => {
    let {id} = req.params
